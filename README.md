...
- Sau khi tải xong slide: **xem tổng quan** (cuộn danh sách) hoặc nhấn nút **play** trên thanh dưới / phím **F** để **trình chiếu** — phím **→** / **Space** slide tiếp, **←** slide trước, **Esc** thoát (khi không fullscreen); chuột phải: laser, vẽ, nhảy slide, danh sách chương. Engine: `js/presentation.js` + `js/presentation-tools.js`.
