...
\begin{figure}[H]
    ...
    \textit{(Chèn hình Figure 2.1/2.2 từ RD1139)}
    \vspace{2.5cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.88\textwidth}{\centering\vspace{2.5cm}
    \textit{(Chèn hình RTL Functional Block Diagram từ RD1139)}
    \vspace{2.5cm}}}
...
\begin{figure}[H]
    ...
    \textit{(Chèn hình I2C Bus Control FSM)}
    \vspace{2cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.75\textwidth}{\centering\vspace{2cm}
    \textit{(Chèn hình I2C Master Control FSM)}
    \vspace{2cm}}}
...
\begin{figure}[H]
    ...
    \textit{(Chèn Timing Diagram for Read and Write Data Transfer)}
    \vspace{1.6cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering\vspace{1.6cm}
    \textit{(Chèn Master Transmit Operation)}
    \vspace{1.6cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering\vspace{1.6cm}
    \textit{(Chèn Master Receive Operation)}
    \vspace{1.6cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering\vspace{1.6cm}
    \textit{(Chèn Repeated Start Operation)}
    \vspace{1.6cm}}}
