module i2c_master_controller_top (i_clk,
 ...
 sky130_fd_sc_hd__conb_1 _1279_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(_0531_));
 sky130_fd_sc_hd__conb_1 _1280_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(_0532_));
 sky130_fd_sc_hd__conb_1 _1281_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(o_cmd_status_reg[0]));
 sky130_fd_sc_hd__conb_1 _1282_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(o_cmd_status_reg[1]));
